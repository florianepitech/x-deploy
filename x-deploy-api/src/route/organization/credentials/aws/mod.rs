...
#[openapi(tag = "Organization Aws Credentials", deprecated)]
#[post("/organization/<id>/credentials/aws", format = "application/json")]
...
#[openapi(tag = "Organization Aws Credentials", deprecated)]
#[get("/organization/<id>/credentials/aws", format = "application/json")]
...
#[openapi(tag = "Organization Aws Credentials", deprecated)]
#[delete("/organization/<id>/credentials/aws", format = "application/json")]
