...
#[openapi(tag = "Organization Aws Credentials")]
#[post("/organization/<id>/aws", format = "application/json")]
...
#[openapi(tag = "Organization Aws Credentials")]
#[get("/organization/<id>/aws", format = "application/json")]
...
#[openapi(tag = "Organization Aws Credentials")]
#[delete("/organization/<id>/aws", format = "application/json")]
