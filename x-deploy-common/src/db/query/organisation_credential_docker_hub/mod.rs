use crate::db::organization_credential_docker_hub::{
  OrganizationCredentialDockerHub,
  ORGANIZATION_CREDENTIAL_DOCKER_HUB_COLLECTION_NAME,
};
...
impl OrganizationCredentialDockerHub {
  pub async fn insert(
    ...
    let collection: Collection<Self> =
      db.collection(ORGANIZATION_CREDENTIAL_DOCKER_HUB_COLLECTION_NAME);
